...
public:
	...
	[[nodiscard]] float GetFloat(const char* keyToken, const float flDefault = 0.0f) const
	{
...
public:
	...
	virtual void FireEvent(IGameEvent* event);
	...
	*/
	...
	float GetFloat2(const char* Name, bool Unk) noexcept;
...
static_assert(sizeof(IGameEvent) == 0x68);
	...
	public:
		...
		bool AddListeners(IGameEventManager2* Listener, const char* MName, bool MBServerSide)
		{
			return CallVFunc<bool, 3U>(this, MName, MBServerSide);
		}


		//virtual bool FindListener(IGameEventManager2* eventListener, const char* name) = 0;
