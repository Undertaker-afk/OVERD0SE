...
public:
	...
	bool get_bool() { return value.i1; }
	int get_int() { return value.i32; }
	float get_float() { return value.fl; }

	bool set_bool(bool valuem) { return value.i1 = valuem; }
	int set_int(int valuem) { return value.i32 = valuem; }
	float set_float(float valuem) { return value.fl = valuem; }
};
