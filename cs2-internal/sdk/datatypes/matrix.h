...
struct Matrix4x2_t
{
	...
	constexpr Matrix4x2_t(const Vector2D_t& vecRow0, const Vector2D_t& vecRow1, const Vector2D_t& vecRow2, const Vector2D_t& vecRow3)
	{
		SetRow0(vecRow0);
		SetRow1(vecRow1);
		SetRow2(vecRow2);
	...
	constexpr void SetRow0(const Vector2D_t& vecRow0)
	{
		arrData[0][0] = vecRow0.x;
		arrData[0][1] = vecRow0.y;
	}

	constexpr void SetRow1(const Vector2D_t& vecRow1)
	{
		arrData[1][0] = vecRow1.x;
		arrData[1][1] = vecRow1.y;
	}

	constexpr void SetRow2(const Vector2D_t& vecRow2)
	{
		arrData[2][0] = vecRow2.x;
		arrData[2][1] = vecRow2.y;
	}

	constexpr void SetRow3(const Vector2D_t& vecRow3)
	{
		arrData[3][0] = vecRow3.x;
		arrData[3][1] = vecRow3.y;
	}

	[[nodiscard]] constexpr Vector2D_t GetRow0() const
	{
		return { arrData[0][0], arrData[0][1] };
	}

	[[nodiscard]] constexpr Vector2D_t GetRow1() const
	{
		return { arrData[1][0], arrData[1][1] };
	}

	[[nodiscard]] constexpr Vector2D_t GetRow2() const
	{
		return { arrData[2][0], arrData[2][1] };
	}

	[[nodiscard]] constexpr Vector2D_t GetRow3() const
	{
		return { arrData[3][0], arrData[3][1] };
	}
	...
	[[nodiscard]] constexpr Matrix4x2_t ConcatTransforms(const Matrix4x2_t& matOther) const
	{
		return {
			arrData[0][0] * matOther.arrData[0][0] + arrData[0][1] * matOther.arrData[1][0],
			arrData[0][0] * matOther.arrData[0][1] + arrData[0][1] * matOther.arrData[1][1],

			arrData[1][0] * matOther.arrData[0][0] + arrData[1][1] * matOther.arrData[1][0],
			arrData[1][0] * matOther.arrData[0][1] + arrData[1][1] * matOther.arrData[1][1],

			arrData[2][0] * matOther.arrData[0][0] + arrData[2][1] * matOther.arrData[1][0],
			arrData[2][0] * matOther.arrData[0][1] + arrData[2][1] * matOther.arrData[1][1],

			arrData[3][0] * matOther.arrData[0][0] + arrData[3][1] * matOther.arrData[1][0],
			arrData[3][0] * matOther.arrData[0][1] + arrData[3][1] * matOther.arrData[1][1]
		};
	}
...
public:
	Vector_t get_origin() {
		return Vector_t(_11, _12, _13);
	}

	void set_origin(int nIndex, Vector_t vecValue) {
